...
export default component$(() => {
  ...
  return (
    <article>
      ...
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Est alias nulla
        dolorem quod magnam tenetur veniam laboriosam qui. Vero voluptatem
        facilis, quisquam debitis fugiat tenetur repellat iste necessitatibus
        culpa sit.
      </p>
      <p>
      ...
      {modalVisible.value && (
        <Modal size="sm" frosted={true} close={close}>
